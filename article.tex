...
Here is an application on previous example:
$$1\ 2\ 2\ 3\ 3\ 3\ 4\ 4\ 4\ 4$$
...
$$(increment(1)(1)(argument))\ (increment(1)(1)(argument))\ (increment(1)(2)(argument))\ (increment(1)(1)(argument))\ (increment(1)(2)(argument))\ (increment(1)(3)(argument))\ (increment(1)(1)(argument))\ (increment(1)(2)(argument))\ (increment(1)(3)(argument))\ (increment(1)(4)(argument))$$
An other time would give:
$$(increment(increment(1)(1)(argument))(1)(times))\ (increment(increment(1)(1)(argument))(2)(times))\ (increment(increment(1)(1)(argument))(3)(times))\ (increment(increment(1)(1)(argument))(4)(times))$$
And a last one:
$$(increment(increment(increment(1)(1)(argument))(1)(times))(4)(times))$$
...
I choose 'times' because it has hence be able to compress a last time given that all increment operators applied on 'times', but I had no right to do so.
...
For the 'dirty' where-to-apply solution, Samuel cleverly suggested that instead of a restrictive three-choices field, I should use a indexes list which could also handle deepness which could indicate where the increment-operator should apply. This is the solution I adopted and customized in my final version.
