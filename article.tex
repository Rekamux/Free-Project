...
As a student at Télécom ParisTech, I chose to follow the 'Non-classical language paradigms' course with Samuel Tardieu\cite{samuel}, 
...
This same field also doesn't have any meaning either when applied to an increment-operator: it cannot apply to its \textit{argument} because the contained increment-operator takes care of that,
